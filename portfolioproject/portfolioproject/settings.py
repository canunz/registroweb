...
SECRET_KEY = 'django-insecure-%l6-ru21ca^ao0qf_)_-s0nm9m_sk$$_4m7g02eyhd!z8=0xac'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'myportfolio/templates')],  # Asegúrate de tener esta línea
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
